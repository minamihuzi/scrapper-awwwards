...
function LivIconsEvoDefaults() {
	...
	var defaultOptions = {
		...
		pathToFolder: base_url + 'app-assets/fonts/LivIconsEvo/svg/', //the path from root of your site to folder with icons. Also may be as URL, like 'http://yoursite.com/path/to/LivIconsEvo/svg/'
