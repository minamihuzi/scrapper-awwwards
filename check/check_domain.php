...
$DOMAINS_OUTPUT_FILE_NAME = "../app-assets/download_files/domains-output".$id.".csv";
...
echo json_encode(["status"=>"success", "total"=>count($dmlist), "available"=>count($domainAvailableList), "result_file"=>"domains-output".$id.".csv"]);
...
if($_POST['action']=="delete"){
    $id=$_POST['id'];
    if(file_exists("../app-assets/download_files/domains-output".$id.".csv"))unlink("../app-assets/download_files/domains-output".$id.".csv");
}else{
